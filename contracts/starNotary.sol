...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Chris Notarized Star";
    ...
    function exchangeStars(
        uint256 _firstUserTokenId,
        uint256 _secondUserTokenId
    ) public {
